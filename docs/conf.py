...
version = '0.0.1' # WARNING: modified by setver.bash
...
html_sidebars = {
    '**': [
        ...
        'globaltoc.html', # tab of contents on the left sidebar
        # 'sourcelink.html',
        # 'searchbox.html',
        # 'sidebar-bottom.html',
    ]
...
man_pages = [
  (master_doc, 'skeleton', 'Skeleton Documentation',[author], 1)
]
...
texinfo_documents = [
    (master_doc, 'skeleton', 'Skeleton Documentation',
     author, 'Skeleton', 'Empty python project template',
     'Miscellaneous'),
]
